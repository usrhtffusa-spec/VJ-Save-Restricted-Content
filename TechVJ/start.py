...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("❣️ Developer", url = "https://t.me/usrhtff009")
    ],[
        InlineKeyboardButton('🤖 Update Channel', url='https://t.me/usrht01')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await client.send_message(
        chat_id=message.chat.id, 
        text=f"👋 Hi {message.from_user.mention}, I am Save Restricted Content Bot, I can send you restricted content by its post link.\n\nFor downloading restricted content /login first.\n\nKnow how to use bot by - /help", 
